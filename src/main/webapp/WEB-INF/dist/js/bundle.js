...
var GreeterComponent = function (_React$Component) {
    _inherits(GreeterComponent, _React$Component);

    function GreeterComponent(props) {
        _classCallCheck(this, GreeterComponent);

        var _this = _possibleConstructorReturn(this, (GreeterComponent.__proto__ || Object.getPrototypeOf(GreeterComponent)).call(this, props));

        _this.state = props;
        console.log("Initial State", JSON.stringify(_this.state));
        return _this;
    }

    _createClass(GreeterComponent, [{
        key: "_onClick",
        ...
        value: function render() {
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    ...
                    _react2.default.createElement("input", { type: "text", ref: "desiredName", onChange: this._onChange.bind(this) }),
                    _react2.default.createElement(
                        "button",
                        { onClick: this._onClick.bind(this), type: "button" },
                        "Clear"
                    )
                )
            );
...
ReactDOM.render(_react2.default.createElement(GreeterComponent, null), document.getElementById('app'));
